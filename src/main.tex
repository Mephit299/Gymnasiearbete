...
% men däremot lite mellanrum
    ...
    \begin{abstract}
        ...
        All users should be able to use a website even if they have a disability.
        ...
        The method to accomplish this was simply to test each criteria of WCAG on all the chosen websites.
