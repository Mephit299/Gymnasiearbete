...
% men däremot lite mellanrum
    ...
    \begin{otherlanguage}{swedish}
        ...
        \begin{titlepage}
            ...
            % Subtitle
            \vspace*{.5cm}
            {\LARGE Webbplatsernas anpassning till WCAG 2.2 standarden och generellt användarvänlighet}
    ...
    \begin{abstract}
        ...
        The method to accomplish this was to test each criteria of WCAG on all the chosen websites with a manual form.
        For criteria related to contrast the tool WAVE was used and criteria that specified that content had to be "programmatically determined" the tool screen reader was used.
        ...
        The study also showed that there might be a tendency for municipalities with least population to have a worse performing website but to draw such a conclusion more websites would have to be tested. % kanske ändra
    ...
    Tillgänglighet i det här sammanhanget betyder inte hur åtkomligt webbplatsen är, istället handlar tillgänglighet om att alla ska kunna använda och förstå webbplatsen. %alla användare inkluderar dom med funktionsnedsättnig
    ...
    Den här nivån är inte alltid realistisk för en webbplats att nå. %utväckla
    ...
    Kommuner med 100 000 invånare och kommuner med 15 000 invånare verkade ha ungefär lika användarvänliga webbplatser.
    ...
    \\_H3eZAPPYyOzse4R0AE8LfQ24HFca-/pubhtml % Endast tillgänglig till personer innom NTI.
