...
% men däremot lite mellanrum
    ...
    Användaren ska inte få några anfall eller fysiska reaktioner av att använda webbplatsen. % har dålig inflytning med rästen av texten.
    ...
    Myndigheten för digital förvaltning (Digg) är ansvarig för att se till att lagen följs och se till att lage efterlevs och de utgår från WCAG standarden för att sätta krav på webbplatsen \parencite{Utförande_av_Dos_lagen}. %Kanske inte vad digg gör
