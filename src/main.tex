...
% men däremot lite mellanrum
    ...
    Finns det några skillnader på antalet invånare i kommunen och hur många krav kommunen uppfyller.
    ...
    Webbstandarden som den här undersökningen åtgår från är WCAG som är utgivet av W3C.
    ...
    Javascript och Typescript är inte relevant till undersökningen.
    ...
    Det som är intressant om kommunal hemsidor är att alla är inte bara en hemsida som ser likadan ut för varje kommun utan de flesta ser annorlunda.
